...
# __all__ = (_tg_classes + _tg_screen_functions + _tg_turtle_functions +
#            _tg_utilities + ['Terminator'] + list(_4t_aliases_dict.values()) ) # + _math_functions)
...
##### make global alias funcs for traditional chinese
# def _make_4t_aliases():
#     name_space = globals()
#     for name, tc_name in _4t_aliases_dict.items():
#         name_space[tc_name] = name_space[name]
